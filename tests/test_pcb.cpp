...
class PCBExecuteTest : public TestFixture
{
   public:
    ...
    void test()
    {
        ...
        assert_equal(p.execute(TIME_QUANTUM), 4, " Process [p] should execute one TIME QUANTUM");
        ...
        assert_equal(p_finish.execute(TIME_QUANTUM), 2, " Process [p_finish] should finish with execute time = 2");
